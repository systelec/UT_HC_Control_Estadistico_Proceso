<template>
  <div>
    <img class="loading" v-if="loadingTv3Grafico" src="../../../static/charts.png" width="50">
...
export default {
  ...
  computed: {
    ...mapGetters([
      'variablesTv3TiempoReal',
      'variablesTv3Historicas',
      'actualizarTv3Grafico',
      'loadingTv3Grafico'
    ])
  },
  ...
  methods: {
    graficarTendencias() {
      let myChart = echarts.init(document.getElementById('GraficoTV3'))

      this.titulo = this.variablesTv3Historicas
        ? this.variablesTv3Historicas.Tendencia
        : ''

      this.fueraLimite = this.variablesTv3Historicas
        ? this.variablesTv3Historicas.Fuera_Limite
        : ''

      let intervalo = 1000000
      let limite = this.variablesTv3Historicas.Limite || null
      let media = 0
      let mediaR = 0
      let lsl = 0
      let usl = 0
      ...
      let hasta = moment(
        this.variablesTv3Historicas ? this.variablesTv3Historicas.Hasta : ''
      )
      let desde = moment(
        this.variablesTv3Historicas ? this.variablesTv3Historicas.Desde : ''
      ).add(-intervalo, 'seconds')

      let historicos = this.variablesTv3Historicas
        ? this.variablesTv3Historicas.Historicos
        : []
