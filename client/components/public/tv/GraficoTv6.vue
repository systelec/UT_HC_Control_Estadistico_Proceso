<template>
  <div>
    <img class="loading" v-if="loadingTv6Grafico" src="../../../static/charts.png" width="50">
...
export default {
  ...
  computed: {
    ...mapGetters([
      'variablesTv6TiempoReal',
      'variablesTv6Historicas',
      'actualizarTv6Grafico',
      'loadingTv6Grafico'
    ])
  },
  ...
  methods: {
    graficarTendencias() {
      let myChart = echarts.init(document.getElementById('GraficoTV6'))

      this.titulo = this.variablesTv6Historicas
        ? this.variablesTv6Historicas.Tendencia
        : ''

      this.fueraLimite = this.variablesTv6Historicas
        ? this.variablesTv6Historicas.Fuera_Limite
        : ''

      let intervalo = 1000000
      let limite = this.variablesTv6Historicas.Limite || null
      let media = 0
      let mediaR = 0
      let lsl = 0
      let usl = 0
      ...
      let hasta = moment(
        this.variablesTv6Historicas ? this.variablesTv6Historicas.Hasta : ''
      )
      let desde = moment(
        this.variablesTv6Historicas ? this.variablesTv6Historicas.Desde : ''
      ).add(-intervalo, 'seconds')

      let historicos = this.variablesTv6Historicas
        ? this.variablesTv6Historicas.Historicos
        : []
