<template>
  <div>
    <img class="loading" v-if="loadingTv1Grafico" src="../../../static/charts.png" width="50">
...
export default {
  ...
  computed: {
    ...mapGetters([
      'variablesTv1TiempoReal',
      'variablesTv1Historicas',
      'actualizarTv1Grafico',
      'loadingTv1Grafico'
    ])
  },
  ...
  methods: {
    graficarTendencias() {
      let myChart = echarts.init(document.getElementById('GraficoTV1'))

      this.titulo = this.variablesTv1Historicas
        ? this.variablesTv1Historicas.Tendencia
        : ''

      this.fueraLimite = this.variablesTv1Historicas
        ? this.variablesTv1Historicas.Fuera_Limite
        : ''

      let intervalo = 1000000
      let limite = this.variablesTv1Historicas.Limite || null
      let media = 0
      let mediaR = 0
      let lsl = 0
      let usl = 0
      ...
      let hasta = moment(
        this.variablesTv1Historicas ? this.variablesTv1Historicas.Hasta : ''
      )
      let desde = moment(
        this.variablesTv1Historicas ? this.variablesTv1Historicas.Desde : ''
      ).add(-intervalo, 'seconds')

      let historicos = this.variablesTv1Historicas
        ? this.variablesTv1Historicas.Historicos
        : []
